...
export default function Users() {
  ...
  async function handleEditSubmit(e) {
    ...
    try {
      ...
      if (payload.role !== 'EMPLOYEE') payload.consumer_id = null
      else payload.consumer_id = Number(payload.consumer_id)
    ...
    <div className={styles.page}>
      <div className={styles.toolbar}>
        <div>
          ...
          {!loading && (
            <p className={styles.pageDesc}>{users.length} usuário(s) cadastrado(s)</p>
          )}
        </div>
      ...
      {showForm && (
        <form className={styles.card} onSubmit={handleSubmit}>
          ...
          <div className={styles.grid}>
            ...
            {form.role === 'EMPLOYEE' && (
              <label className={styles.label}>
                Consumer ID <span className={styles.hint}>(1–999, nº do crachá)</span>
      ...
      {editingUser && (
        <form className={styles.card} onSubmit={handleEditSubmit}>
          <h2 className={styles.cardTitle}>
            Editar — <span className={styles.editUsername}>{editingUser.username}</span>
          </h2>
                  ...
                  <td>
                    {u.id !== user?.id && (
                      <div className={styles.rowActions}>
                        ...
                        <button className={styles.btnDelete} onClick={() => handleDelete(u)}>Excluir</button>
                      </div>
                    )}
                  </td>
                </tr>
